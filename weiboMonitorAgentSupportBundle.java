...
/**
 * A class that can contribute information about the weiboMonitorAgent to 
 * any support bundle that is generated.
 */
public class weiboMonitorAgentSupportBundle implements SupportBundleListener {

/** A reference to the main agent class so we can collect information from it */
private final weiboMonitorAgentImpl mweiboMonitorAgent;

/**
 * Creates a new support bundle contributer.
 */
public weiboMonitorAgentSupportBundle(weiboMonitorAgentImpl agent) {
    mweiboMonitorAgent = agent;
}
...
public String getSuggestedLocation() { 
    return "weiboMonitorAgent" + File.separator + "info.txt";
}
...
public String getCollectorName() {
    return "weiboMonitorAgent information";
}
...
public void collectText(OutputStream output) throws Exception {
    ...
    out.println("The weiboMonitorAgent has something to say");
}
